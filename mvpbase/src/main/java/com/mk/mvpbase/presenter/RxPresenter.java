...
import com.mk.mvpbase.presenter.delivery.DeliverFirst;
import com.mk.mvpbase.presenter.delivery.DeliverLatestCache;
import com.mk.mvpbase.presenter.delivery.DeliverReplay;
import com.mk.mvpbase.presenter.delivery.Delivery;
import com.mk.mvpbase.view.OptionalView;
...
public class RxPresenter<View> extends Presenter<View> {
    ...
    /**
     * Registers a disposable to automatically unsubscribe it during onDestroy.
    ...
    public <T> void restartableFirst(int restartableId, final Factory<Observable<T>> observableFactory,
        ...
        restartable(restartableId, new Factory<Disposable>() {
            @Override
            public Disposable create() {return observableFactory.create()
    ...
    protected void onCreate(Bundle savedState) {
        if (savedState != null && savedState.getIntegerArrayList(REQUESTED_KEY)!=null)
