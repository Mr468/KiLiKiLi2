...
import com.mk.kilikili.widget.recyclerview.animation.AlphaInAnimation;
import com.mk.kilikili.widget.recyclerview.animation.AnimationType;
import com.mk.kilikili.widget.recyclerview.animation.BaseAnimation;
import com.mk.kilikili.widget.recyclerview.animation.CustomAnimation;
import com.mk.kilikili.widget.recyclerview.animation.ScaleInAnimation;
import com.mk.kilikili.widget.recyclerview.animation.SlideInBottomAnimation;
import com.mk.kilikili.widget.recyclerview.animation.SlideInLeftAnimation;
import com.mk.kilikili.widget.recyclerview.animation.SlideInRightAnimation;
import com.mk.kilikili.widget.recyclerview.animation.SlideInTopAnimation;
import com.mk.kilikili.widget.recyclerview.listener.OnDragAndSwipeListener;
import com.mk.kilikili.widget.recyclerview.listener.OnRecyclerItemClickListener;
import com.mk.kilikili.widget.recyclerview.listener.OnRecyclerItemLongClickListener;
import com.mk.kilikili.widget.recyclerview.listener.RequestLoadMoreListener;
import com.mk.kilikili.widget.recyclerview.view.FooterView;
import com.mk.kilikili.widget.recyclerview.view.LoadType;
...
public abstract class BaseRecyclerAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements OnDragAndSwipeListener {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        BaseVHolder baseVHolder = null;
        switch (viewType) {
            case VIEW_TYPE_HEADER:
                baseVHolder = new BaseVHolder(mHeaderLayout);
                break;
            default:
            case VIEW_TYPE_CONTENT:
                baseVHolder = onBaseViewHolder(parent, viewType);
                initItemClickListener(baseVHolder);
                // get default background drawable
                mBackgroundDrawable = baseVHolder.getConvertView().getBackground();
                break;
            case VIEW_TYPE_FOOTER:
                baseVHolder = new BaseVHolder(mFooterView);
                break;
            case VIEW_TYPE_EMPTY:
                baseVHolder = new BaseVHolder(mEmptyView);
                break;
            case VIEW_TYPE_LOADING:
                baseVHolder = addLoadingView(mLoadType);
                break;
        }
        return baseVHolder;
    }
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, int position) {
        ...
        switch (mViewType) {
            ...
            default:
            case VIEW_TYPE_CONTENT:
                convert((BaseVHolder) holder, mData.get(holder.getLayoutPosition() - getHeaderViewCount()));
        ...
        if (mItemTouchHelper != null && mViewType == VIEW_TYPE_CONTENT) {
            if (mDragViewId != DEFAULT_DRAG_VIEW) {
                View dragView = ((BaseVHolder) holder).getView(mDragViewId);
                if (dragView != null) {
     ...
     * @return
     */
    protected BaseVHolder createBaseViewHolder(ViewGroup parent, int layoutResId) {
        if (mContentView == null) {
            return new BaseVHolder(getItemView(layoutResId, parent));
        }
        return new BaseVHolder(mContentView);
    }
     ...
     * @param baseVHolder
     */
    private void initItemClickListener(final BaseVHolder baseVHolder) {
        if (onRecyclerItemClickListener != null) {
            baseVHolder.itemView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    onRecyclerItemClickListener.onItemClick(v, baseVHolder.getLayoutPosition() - getHeaderViewCount());
                }
            });
        }
        if (onRecyclerItemLongClickListener != null) {
            baseVHolder.itemView.setOnLongClickListener(new View.OnLongClickListener() {
                @Override
                public boolean onLongClick(View v) {
                    return onRecyclerItemLongClickListener.onItemLongClick(v, baseVHolder.getLayoutPosition() - getHeaderViewCount());
                }
            });
        }
    }
